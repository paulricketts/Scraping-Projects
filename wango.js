...
function _IG_FetchFeedAsJSON(b, f, c, a, d) {
    ...
    gadgets.io.makeRequest(b, function(j) {
        ...
        if (j.data.items && j.data.items.length > 0) {
            ...
            for (var h = 0; h < j.data.Entry.length;
                ++h) {
        ...
        for (var g = 0; g < j.data.Entry.length;
            ++g) {
...
(function() {
        ...
        try {
            if (++window._varz_numerrors, gadgets && !(3 < f)) {
                ...
                var d = gadgets.util.getUrlParameters(),
                    ...
                    g = d.gadget || d.url,
                    k = ["/gadgets/evthdlr?t=err&gadget=", a(g), "&container=", a(e), "&jsurl=", a(b.jsUrl), "&line=", a(b.line), "&session=", h, "&count=", f, "&msg=", a(b.msg)];
    ...
    var h = (new Date).getTime(),
        f = 0; - 1 == window.location.href.indexOf("&debug=1") && -1 == window.location.href.indexOf("?debug=1") && (window.onerror = e)
})();;
...
(function() {
    var l = null,
        p = function() {
            ...
            function y(a) {
                if (a === l) return l;
                for (var a = a.replace(/(^|\/)\.(?:\/|$)/g, "$1").replace(/\/{2,}/g, "/"), e = m, b;
                    (b = a.replace(e, "$1")) != a; a = b);
                return a
            }
            ...
            function A(a, e) {
                ...
                var m = e.g,
                    k = y(m);
                if (g) b.ba(e.T()), k = k && k.replace(x, "");
                else if (g = !!m) {
                    if (47 !== k.charCodeAt(0)) var k = y(b.g || "").replace(x, ""),
                        s = k.lastIndexOf("/") + 1,
    ...
    var Q = function(e) {
            ...
            function q(f) {
                ...
                return function(f, e) {
                    ...
                    if (Y) c = c.split(b);
                        ...
                        for (var i = [], h = 0, n;
                            (n = b.exec(c)) !== l;) i.push(c.substring(h, n.index)), i.push(n[0]), h = n.index + n[0].length;
                ...
                try {
                    ...
                    for (var b,
                        ...
                        switch (r) {
                            ...
                            case "</":
                                if (b = /^([-\w:]+)[^\'\"]*/.exec(k))
                                    if (b[0].length === k.length && ">" === a[d + 1]) d += 2, h = b[1].toLowerCase(), f.r && f.r(h, c, t, m(f, a, d, j, c));
                                    else {
                                        var g = a,
                                            o = d,
                                            q = f,
            ...
            function E(a, w, d, j, c, u) {
                ...
                r < i && (r -= 1);
                i = a.slice(n, r).join("");
                if (w.c & e.c.CDATA) d.z && d.z(i, j, c, m(d, a, r, u, j));
                else if (w.c & e.c.RCDATA) d.F && d.F(b(i), j, c, m(d, a, r, u, j));
            ...
            function K(a, b, d) {
                return function(j, c) {
                    if (e.f[j] & e.c.UNSAFE) d && v(d, j, void 0, void 0, void 0);
                    else return {
                        attribs: g(j, c, a, b, d)
                    }
                }
            ...
            var G = {
                ...
                T = /^[A-Za-z][A-za-z0-9]+$/,
                H = "undefined" !==
                typeof window && window.document ? window.document.createElement("textarea") : l,
                aa = /\0/g,
                U = /&(#[0-9]+|#[xX][0-9A-Fa-f]+|\w+);/g,
                Z = /^(#[0-9]+|#[xX][0-9A-Fa-f]+|\w+);/,
                V = /&/g,
                X = /&([^a-z#]|#(?:[^0-9x]|x(?:[^0-9a-f]|$)|$)|$)/gi,
                M = /[<]/g,
                N = />/g,
                W = /\"/g,
                $ = /^\s*([-.:\w]+)(?:\s*(=)\s*((")[^"]*("|$)|(')[^']*('|$)|(?=[a-z][-\w]*\s*=)|[^"'\s]*))?/i,
                Y = 3 === "a,b".split(/(,)/).length,
